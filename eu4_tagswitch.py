...
EU4BIN_PLAYER_TOKEN = b"\x38\x2a"
EU4BIN_ASSIGNMENT_OPERATOR_TOKEN = b"\x01\x00"
EU4BIN_STRING_TYPE_TOKEN = b"\x0f\x00"
...
def tag_replace(metadata, tag):
    if (metadata.startswith(b"EU4bin")):
        ...
        metadata[pos + prefix_length + 2 : pos + prefix_length + 2 + len(tag)] = tag.encode('utf-8')
